...
#TitleButton { background: transparent; color: #333; border-radius: 4px; min-width: 30px; font-size: 30px; padding: 0px; }
...
#TitleButton { background: transparent; color: #eee; border-radius: 4px; min-width: 30px; font-size: 30px; padding: 0px; }
